import {IssueDetailComponent} from '@viacheslav/project/components/issues/issue-detail/issue-detail.component';
import {IssuePriority, IssueStatus, IssueType} from '@viacheslav/interface/issue';
